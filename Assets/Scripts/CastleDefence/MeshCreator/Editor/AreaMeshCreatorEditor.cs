...
namespace CastleDefence.MeshCreator.Editor
{
	...
	public class AreaMeshCreatorEditor : UnityEditor.Editor
	{
		...
		protected Vector2 m_RectSize = new Vector2(1, 2);
		...
		public override void OnInspectorGUI()
		{
			...
			m_RectSize = EditorGUILayout.Vector2Field("Rectangle Size", m_RectSize);
			if (GUILayout.Button("Rectangle"))
			{
				SetRectangle(m_RectSize);
			}
		...
		protected void SetRectangle(Vector2 rectSize)
		{
			ClearCurrentPoints();
			Vector3 center = m_AreaMeshCreator.pointsCenter.position;
			float halfX = rectSize.x / 2f;
			float halfZ = rectSize.y / 2f;
			CreateNewPoint(center + new Vector3(halfX, 0, halfZ));
			CreateNewPoint(center + new Vector3(-halfX, 0, halfZ));
			CreateNewPoint(center + new Vector3(-halfX, 0, -halfZ));
			CreateNewPoint(center + new Vector3(halfX, 0, -halfZ));
			CreateMesh();
